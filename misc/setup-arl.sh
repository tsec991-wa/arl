...
if [ ! -d ARL ]; then
  ...
  git clone https://github.com/tsec991-wa/arl
fi

if [ ! -d "ARL-NPoC" ]; then
  echo "git clone ARL-NPoC proj"
  git clone https://github.com/tsec991-wa/arl/ARL-NPoC
fi
...
if [ ! -f /data/GeoLite2/GeoLite2-ASN.mmdb ]; then
  ...
  wget https://github.com/tsec991-wa/arl_files/blob/master/GeoLite2-ASN.mmdb -O /data/GeoLite2/GeoLite2-ASN.mmdb
fi

if [ ! -f /data/GeoLite2/GeoLite2-City.mmdb ]; then
  echo "download GeoLite2-City.mmdb ..."
  wget https://github.com/tsec991-wa/arl_files/blob/master/GeoLite2-City.mmdb -O /data/GeoLite2/GeoLite2-City.mmdb
fi
